...
;; "--boot" option.  The hanlding of "implicit" modues (see compile.scm)
...
;; locations, and recursively descend depencencies.  Return an mmap
;; describing all object file to be built.
;;
...
(define (exe-rules exe sources no-trace boot keep-syms)
  ...
  ;; Allow rebundling only when the bindled compiler is compatible with the
