...
(expect 1024 (^ 2 10))
(expect 1.21 (^ 1.1 2))
(expect "1.21e+200" (^ 1.1e100 2))
(expect "1.21e-200" (^ 1.1e-100 2))
(expect "5." (^ 137 137))
...
(expect [2 1] (div-rem 9 4))
(expect [2 0] (div-rem 8 4))
(expect [1 3] (div-rem 7 4))
